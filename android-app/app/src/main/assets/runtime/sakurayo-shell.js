(function (global) {
  ...
  var CSS =
    ...
    "html.landscape46.shortWindow46 #homeWallet46 .homeChip46,html.landscape46.shortWindow46 .homeXp46,html.landscape46.shortWindow46 .homeRec46{display:none!important}" +
    ...
    ".railIco46.ach:before{content:\"\";position:absolute;left:1px;top:1px;width:14px;height:14px;border:1.6px solid #f2c75d;border-radius:50%;box-shadow:inset 0 0 0 2px #120e27}" +
    ".railIco46.ach:after{content:\"\";position:absolute;left:4px;top:4px;width:8px;height:8px;background:#f2c75d;clip-path:polygon(50% 0,63% 34%,100% 38%,70% 62%,79% 100%,50% 78%,21% 100%,30% 62%,0 38%,37% 34%)}" +
  ...
  var NOTICES = Object.freeze([
    ...
    { id: "shop", title: "补给柜写入火力", sub: "核心道具加伤害，兑换区只换货币", body: "衣装改外观倾向。核心、道具、寻访证词都会写入火力。兑换区只换货币。" },
  ]);
  ...
  function storyBlock(api) {
    ...
    var html = '<p>正文章节仍走樱夜档案。通关后的抉择留在剧情房。</p><div class="shellList46">';
    rows.forEach(function (row) {
      html +=
        '<div class="shellItem46"><i>' +
        (row.on ? row.i || "章" : "?") +
