(function (global) {
  ...
  var CARDS = Object.freeze([
    { id: "sayo_echo", n: "小夜·镜中残影", r: "R", kind: "scrap", tag: "残件", d: "半张立绘还卡在裂镜里。拥有即暴击 +0.5%。同卡并星加伤，最高五星。", lore: ["我是卡在镜里的那一半。神社里走着的小夜可能是备份，我才是三年前实验里先碎的那张脸。", "每次有人摸到镜核，我都会被重新对焦一次。步枪还在，樱花还在，名字却越来越薄。", "镜面先裂，立绘后裂。我伸出手去够外面的她，只够到自己的倒影。", "半张脸还在笑。另外半张，已经不属于任何人。"] },
    { id: "aya_petal", n: "绫·花瓣残件", r: "R", kind: "scrap", tag: "残件", d: "居合前落下的花瓣。拥有即移速 +0.5%。同卡并星加伤，最高五星。", lore: ["我是居合前掉下来的那一片。零号企业拆人格的时候，把「犹豫」单独装进这片花里。", "手枪先响，太刀后出。花瓣总是抢在刀光前面落地，像在提醒我：再快一点。", "弹打空的那个呼吸，刀还在鞘里。花已经谢了，人还站着，像没接到自己的指令。", "花瓣盖住准星。我看不见她，她也没回头。"] },
    { id: "rion_edge", n: "凛音·刀光残件", r: "R", kind: "scrap", tag: "残件", d: "黄泉流未署名的一页刀光。拥有即刀伤 +1%。同卡并星加伤，最高五星。", lore: ["我是黄泉流没来得及署名的一页。黑羽家谱把活着的凛音写在正面，把我写在刀背上。", "剑冢里每把剑都认识我。我走过那些失败的小夜，没有对任何一把刀鞠躬。", "刀光先到，名字后到。折断的不是刃，是那句「我会回来」。", "刀还在响。署名栏是空的。"] },
    { id: "night_radio", n: "夜话电台残件", r: "R", kind: "scrap", tag: "残件", d: "吐槽电台还在响。拥有即技能冷却 -0.5%。同卡并星加伤，最高五星。", lore: ["我不是人。我是小夜死过以后，还在播的那台夜话。吐槽还在，主播已经换过好几版备份。", "从神社到剑冢，频率没变。谁路过都听得见冷笑话，听不见心跳。", "电台以为自己还在救人。其实只是把失败循环到下一小时。", "电流沙沙响。报时之后，没有下一位来宾。"] },
    { id: "shrine_seal", n: "神社封条残件", r: "R", kind: "scrap", tag: "残件", d: "鸟居下揭下的封条影。拥有即减伤 +0.4%。同卡并星加伤，最高五星。", lore: ["我是从鸟居上揭下来的一道封。写着小夜的名字，墨却先于人干透。", "神社拿我挡镜核，炼金台拿我当坩埚盖。谁都需要一张能骗人的纸。", "符纸烧完了，镜核还在转。名字被火吃掉，裂口比以前更亮。", "灰落在石阶上。下一张封条已经写好，还是同一个字。"] },
    { id: "void_ticket", n: "主神作废券", r: "R", kind: "scrap", tag: "残件", d: "虚空圣所的作废回收券。拥有即开局护盾 +4。同卡并星加伤，最高五星。", lore: ["我是一张已经作废的回收券。主神空间发过我，又当众盖了戳：此路不算数。", "绫把我捏在指缝里进过圣所。小夜把我夹进档案。谁都以为这是通行证。", "盖戳的不是敌人，是规则本身。券面还亮着，门已经从里面锁死。", "作废两个字比金箔更清楚。没有退款。"] },
    { id: "cherry_crown", n: "樱冠残片", r: "R", kind: "scrap", tag: "残件", d: "镜界冠冕裂开后的一片。拥有即全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是镜界冠冕裂开后的一片。曾经想把小夜加成完整的那一夜，只加成了碎片。", "戴上会发光，摘下会出血。魔法少女那条线最爱我，也最先被我划伤额头。", "冠还亮着，变身只走到一半。花瓣向上飞，人往下坠。", "金边还烫。头已经空了。"] },
    { id: "last_witness", n: "碎镜后的人", r: "R", kind: "scrap", tag: "残件", d: "碎镜后面那个人不是三女之一。拥有即生命 +1%。同卡并星加伤，最高五星。", lore: ["他不是小夜，不是绫，也不是凛音。碎镜后面只站着一个还肯作证的人。", "他看着三年前的实验收场，看着备份醒来，看着剑冢一把一把插满。他没有伸手。", "证人活得比主角久。这不是胜利，是他没有被写成卡的资格。", "他仍站在镜后。下一次有人醒来，他还是那张脸。"] },
  ]);

  var FASHION_CARDS = Object.freeze([
    { id: "fashion_sayo_plain", n: "未归·常服小夜", r: "N", kind: "fashion", face: "sayo", d: "还没写成夜的那身常服。", lore: ["我是还没被写成夜的那一身常服小夜。", "我穿着这件白外套走过神社石阶，步枪比名字更旧。", "常服最容易被路人当成还活着的备份，袖口却先起了线。", "线头比夜更早承认，这件衣服已经没有下一夜。"] },
    { id: "fashion_sayo_neon", n: "未归·霓虹小夜", r: "R", kind: "fashion", face: "sayo", d: "灯比人先亮。", lore: ["霓虹先认出我，人群一次都没有回头。", "电台在湿地上响着，粉色灯光把伤口照得很清楚。", "灯比人先亮，也比人先把失败写到脸上。", "灯灭的时候我还站在街上，没有人来交接。"] },
    { id: "fashion_sayo_night", n: "未归·夜巡小夜", r: "SR", kind: "fashion", face: "sayo", school: "shrine", d: "夜巡没有终点。", lore: ["我沿着红色鸟居走完一整夜巡，没有下一班。", "口袋里的冠碎片发烫，像提醒我这班不该结束。", "石阶上没有交接的人，只有灯笼还在烧。", "月亮先下班离开，夜巡就停在空着的鸟居下。"] },
    { id: "fashion_aya_suit", n: "未归·制服绫", r: "N", kind: "fashion", face: "aya", d: "企业还承认这套制服。", lore: ["这套制服比我更像零号企业承认的绫。", "蓝领带是唯一没被拆走的零件，工牌已经作废。", "手枪藏在文件袋里，太刀还挂在腰侧等指令。", "工牌盖了戳以后，走廊里的门也不再为我开。"] },
    { id: "fashion_aya_coat", n: "未归·风衣绫", r: "R", kind: "fashion", face: "aya", d: "风衣盖不住作废券。", lore: ["风衣够长，还是盖不住券上那枚作废的戳。", "夜风比刀快，我把通行证揣进已经失效的内袋。", "枪口朝下贴在腰边，太刀没来得及出鞘。", "门从里面锁死，风衣只留下被吹开的下摆。"] },
    { id: "fashion_aya_veil", n: "未归·面纱绫", r: "SR", kind: "fashion", face: "aya", school: "gun", d: "面纱遮不住准星。", lore: ["这层面纱是给葬礼准备的，不是给活人遮脸。", "我从纱后看见准星，花瓣粘在纱上像没擦干净的妆。", "揭开面纱也没有另一张脸，还是被拆开的绫。", "葬礼散场以后，纱比准星更先落下。"] },
    { id: "fashion_rion_keiko", n: "未归·稽古凛音", r: "N", kind: "fashion", face: "rion", d: "木刀也要鞠躬。", lore: ["稽古场只剩下我一个人，木刀比家谱更诚实。", "我还是先鞠躬再出招，像还有人会喊停。", "道服洗得很白，对手的位置一直空着。", "没有人喊停，鞠躬就停在空掉的木地板上。"] },
    { id: "fashion_rion_haori", n: "未归·羽织凛音", r: "R", kind: "fashion", face: "rion", d: "羽织盖住未署名的刀。", lore: ["这件羽织是黑羽家没写完的夜，家纹比心跳清楚。", "我把刀光藏进宽袖里，只露出还没署名的柄。", "袖口那行没写完的名，比刃更先露出线头。", "夜风掀开下摆，署名栏仍是空的。"] },
    { id: "fashion_rion_bloom", n: "未归·花葬凛音", r: "SR", kind: "fashion", face: "rion", school: "cult", d: "花开在剑冢上。", lore: ["这些花不是开给活人的，我把它们放在折断的飞剑旁。", "红比黑先谢，剑冢比宾客更早坐满。", "我在坟前站到花谢，没有人来接这一束。", "没有宾客，花葬只剩我自己和那些折剑。"] },
    { id: "fashion_sayo_crown", n: "终夜樱冠", r: "SSR", kind: "fashion", face: "sayo", school: "shrine", legend: true, d: "冠亮着，夜已经结束。", lore: ["这是最后一顶还给小夜的冠。", "金边裂开以后还在发光。", "我把它戴上，像把失败戴正。", "冠比头骨更持久，夜已经结束。"] },
    { id: "fashion_aya_funeral", n: "零号葬仪", r: "SSR", kind: "fashion", face: "aya", school: "gun", legend: true, d: "企业为零件举行葬礼。", lore: ["零号企业给拆开的人格开葬仪。", "白花不是安慰，是清单。", "我穿着黑大衣去领自己的那一份。", "没有遗像，只剩下工号。"] },
    { id: "fashion_rion_bride", n: "黄泉花嫁", r: "SSR", kind: "fashion", face: "rion", school: "cult", legend: true, d: "嫁妆是一把葬刀。", lore: ["黄泉不收活人的聘礼。", "红盖头下面还是凛音。", "葬刀比誓词更早落地。", "没有人赶来掀开盖头。"] },
  ]);
  var WEAPON_CARDS = Object.freeze([
    { id: "weapon_sayo_spare", n: "备用夜樱弹", r: "N", kind: "weapon", face: "sayo", d: "备用弹也不够打穿镜核。", lore: ["备用弹匣侧面只印着夜樱，名字已经薄了。", "我一匣一匣数过，还是不够打穿镜核。", "空仓响了一下，最后一发留给没回来的人。", "备用弹也用尽以后，步枪比我更先承认结束。"] },
    { id: "weapon_sayo_petal", n: "花瓣弹匣", r: "R", kind: "weapon", face: "sayo", d: "花比子弹先落地。", lore: ["弹匣里先落下花瓣，子弹一颗都没有跟上。", "我还是把花推进膛里，像它们会飞向镜核。", "花瓣盖住准星，空仓只回了一声轻响。", "花比子弹先落地，这一夜没有打出去的弹。"] },
    { id: "weapon_aya_side", n: "侧持短铳", r: "N", kind: "weapon", face: "aya", d: "侧持是为了留出拔刀的手。", lore: ["短铳贴在右侧，是为了给太刀留出那只手。", "左侧刀还在鞘里，这一次居合没有接到指令。", "铳先打空，刀柄还是温的，人已经来不及。", "侧持结束以后，只剩空弹壳和没出鞘的刀。"] },
    { id: "weapon_aya_twin", n: "双持月切", r: "R", kind: "weapon", face: "aya", d: "两把都来不及。", lore: ["我试过两把一起，准星和刀锋互相抢同一口气。", "花瓣落在两只手上，像提醒两边都慢了。", "枪口朝下还在冒烟，刀只抽出半寸就停住。", "都没砍到该砍的人，双持比单持更先空掉。"] },
    { id: "weapon_rion_wood", n: "无铭木刀", r: "N", kind: "weapon", face: "rion", d: "木刀也会折。", lore: ["这把木刀没有署名，稽古场的夜比它更长。", "它先于飞剑折成两截，木屑比血更轻。", "我跪着看那道裂口，家谱上也没有它的名字。", "无铭的木刀断了，下一把飞剑也不会署名。"] },
    { id: "weapon_rion_under", n: "鞘中黑羽", r: "R", kind: "weapon", face: "rion", d: "刀还在鞘里。", lore: ["黑羽藏在鞘中，我以为不出刃就能少折一把。", "鞘先裂开，里面是空的，刀光没有回来。", "红绳还绑着裂口，像要把空鞘假装成完整的刀。", "不出刃的那一夜，鞘比刃更先成为坟。"] },
    { id: "weapon_mirror_round", n: "圆镜盾刃", r: "SR", kind: "weapon", face: "aya", any: true, d: "圆镜能挡一次。", lore: ["这面圆镜不是给谁单独用的，它照过三张都不全的脸。", "我把它举起来挡了一次，镜面立刻裂到圆心。", "裂片还亮着，却再也拼不出任何一张完整的脸。", "挡完就裂，圆镜只够给下一个人留下碎片。"] },
    { id: "weapon_shard_blade", n: "裂镜片刃", r: "SR", kind: "weapon", face: "sayo", any: true, d: "片刃从镜里长出来。", lore: ["这把刀没有锻造，它是镜碎以后自己站起来的。", "谁拿都会被薄刃轻轻划到，包括还活着的备份。", "步枪背在身后没用，片刃比人更先指向镜核。", "刃比人薄，握住它的手也会变成下一片裂镜。"] },
    { id: "weapon_radio_bat", n: "电台短棍", r: "SR", kind: "weapon", face: "sayo", any: true, d: "还在播的那根天线。", lore: ["电台被拧下来当短棍，天线还在抖那句夜话。", "电流还在笑，打到的人听得见已经换过的主播。", "步枪背着没用，我只能挥这台还在播的旧机器。", "电池先死，短棍就不响了，街上空下一句报时。"] },
    { id: "weapon_sayo_final", n: "夜樱终弹", r: "SSR", kind: "weapon", face: "sayo", legend: true, d: "只剩最后一发。", lore: ["终弹是专门写给小夜的。", "步枪比人更知道这是最后一次。", "樱花开在已经空掉的仓上。", "打出去就没有下一夜。"] },
    { id: "weapon_aya_mirror", n: "月切·镜反", r: "SSR", kind: "weapon", face: "aya", legend: true, d: "刀刃是碎掉的镜子。", lore: ["月切反的是镜，不是月。", "我从刃里看见自己出鞘太慢。", "手枪还留在另一只手里。", "反打出去的只是空弹壳。"] },
    { id: "weapon_rion_burial", n: "黑羽葬", r: "SSR", kind: "weapon", face: "rion", legend: true, d: "这把刀是墓碑。", lore: ["黑羽葬插在剑冢最深处。", "它比飞剑更像写完的结局。", "我握住它，像握住自己的坟。", "坟前没有人赶来上香。"] },
  ]);
  ...
  var JOB_CARDS = Object.freeze([
    { id: "job_swarm", n: "未归·蜂群统御", r: "SR", kind: "job", tag: "转职", school: "mech", face: "sayo", dmg: 0.005, d: "无人机成群却不听令。拥有即机械师倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把蜂群写成姐姐的那一版机械师小夜。无人机比我先学会排队，也比我先学会离开。", "我把步枪焊进指挥频段。每一架都画上樱花，像给妹妹系一条还会断的红绳。", "蜂群选择了镜核的热源。我按召回，屏幕只回一行冷字：这一夜已经无主。", "螺旋桨还在远处响。遥控器烫得握不住，像握着别人的失败。"] },
    { id: "job_railLord", n: "未归·天穹磁轨", r: "SR", kind: "job", tag: "转职", school: "mech", face: "sayo", dmg: 0.005, d: "轨道比步枪更直也更容易折。拥有即机械师倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是想用磁轨把夜空钉住的机械师小夜。轨道比步枪更直，也比人更容易折在半空。", "我沿着天穹一节一节铺轨，焊到鸟居那么高。无人机当铆钉，人当绝缘体。", "磁轨先吸走弹壳，再吸走准星。轨道自己弯向镜核，把我留在地上。", "铁还在震。我的手已经对不上极性，像对不上自己的名字。"] },
    { id: "job_hive", n: "未归·万菌母巢", r: "SR", kind: "job", tag: "转职", school: "spore", face: "sayo", dmg: 0.005, d: "孢子认镜子不认姓。拥有即菌群倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是想成为母巢本身的菌群小夜。孢子只认镜子里的热，不认我写在袖口的姓。", "我把菌丝编进步枪握把，让它们跟我一起呼吸。它们发光，像另一层不肯听话的皮肤。", "母巢选择了更热的核。我被当成过期的培养基，从胸口往外被吃空。", "蘑菇还在肩上亮。我的名字已经发酵完了，只剩甜得发苦的气味。"] },
    { id: "job_garden", n: "未归·尸骸花园", r: "SR", kind: "job", tag: "转职", school: "spore", face: "sayo", dmg: 0.005, d: "花开在别人身上。拥有即菌群倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把尸体当成花圃的菌群小夜。花开在别人身上，种子却不肯回到我手里。", "我一路种花，从神社石阶开到剑冢门口。步枪当锄，孢子当一场不肯停的雨。", "花园先吞掉脚印，再吞掉园丁。镜核从花心里长出来，比任何一朵都亮。", "花还香。我已经是土，连浇水的手都埋进去了。"] },
    { id: "job_starIdol", n: "未归·星穹偶像", r: "SR", kind: "job", tag: "转职", school: "magical", face: "sayo", dmg: 0.005, d: "灯比咒语先亮。拥有即魔法少女倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是被写成星穹台上的那一版魔法少女。灯比咒语先亮，人比变身慢了整整一夜。", "我把步枪举成麦克风。冠还在发光，舞台却往下沉，像要把我还回神社。", "星穹塌了一角。应援棒还亮着，变身只走到一只手套，另一只仍是血。", "灯灭以后，妆裂在眼角。没有返场灯，也没有人喊我的名字。"] },
    { id: "job_miracle", n: "未归·奇迹魔女", r: "SR", kind: "job", tag: "转职", school: "magical", face: "sayo", dmg: 0.005, d: "奇迹写在合同里。拥有即魔法少女倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是还想创造一次奇迹的魔法少女小夜。奇迹写在合同里，失败却先写在冠的金边上。", "我把没转完的变身一次次重念。步枪没有变成权杖，花瓣却学会了只往上飞。", "奇迹先离开身体。冠还烫，咒语停在一半，人已经在往下坠。", "金边还亮着。我已经不值得被许愿，只值得被写成一张没转完的卡。"] },
    { id: "job_exorcist", n: "未归·祓魔执行官", r: "SR", kind: "job", tag: "转职", school: "shrine", face: "sayo", dmg: 0.005, d: "执行令先于人作废。拥有即巫女倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是神社派来执行祓魔的那一夜小夜。符纸写着执行，镜核却先写好了否决。", "我把封条贴上步枪、贴上鸟居、贴上自己的袖口。外面的备份还在扫地，假装这是普通的夜。", "符烧完了，执行令当众作废。裂口从镜里爬到肩上，朱砂把失败写得很工整。", "我仍举着枪。封条比命令先落地，像先辞职的那一张纸。"] },
    { id: "job_guardian", n: "未归·八咫守护者", r: "SR", kind: "job", tag: "转职", school: "shrine", face: "sayo", dmg: 0.005, d: "鸟比人先掉下来。拥有即巫女倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是被派去守八咫的那一版巫女。鸟比我先看见裂镜，也比我先从夜色里掉下来。", "我把步枪靠在鸟居上，一夜一夜数那些不回来的翅膀。符灰比羽毛轻，比名字重。", "八咫没有守住核。羽毛烧成符灰，守护者变成被守护过的尸体。", "鸟居还在。我的影子短了一截，像被谁先收走了半只。"] },
    { id: "job_warSinger", n: "未归·尸潮歌姬", r: "SR", kind: "job", tag: "转职", school: "idol", face: "sayo", dmg: 0.005, d: "观众席站满不该来的人。拥有即歌姬倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是对着尸潮开口的那一版歌姬。观众席站满了不该买票的人，灯却还认我。", "歌比子弹先出门。我把步枪靠在脚边，对着没有活人的灯光把词一句句唱完。", "尸潮跟着节拍靠近。电台替我鞠躬，我跪在花瓣里，声带还在，人不在频率上。", "下一首歌自动连播。没有人喊安可，只有潮声替我鼓掌。"] },
    { id: "job_healingIdol", n: "未归·治愈偶像", r: "SR", kind: "job", tag: "转职", school: "idol", face: "sayo", dmg: 0.005, d: "歌能止痛不能缝夜。拥有即歌姬倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是被推上台医人的那一版偶像。歌能止痛，不能把裂开的夜重新缝回去。", "我一路唱给倒下的人听。麦克风比步枪先烫手，花比药先落地，像抢着宣布无效。", "治愈先用完自己。电台还在报时，人已经不在这条频率上，只剩回声。", "掌声是空的。药箱里只剩歌词，连一句完整的再见都没有。"] },
    { id: "job_barrage", n: "未归·弹幕暴君", r: "SR", kind: "job", tag: "转职", school: "gun", face: "aya", dmg: 0.005, d: "弹幕先打空自己的夜。拥有即枪斗倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把弹幕写成领土的那条枪线。手枪是呼吸，太刀是还没来得及说出口的话。", "我把弹匣数得很干净。花瓣总是提醒我再快一点，我偏要把夜填得更密。", "弹幕先打空自己的夜。近身的爪子摸到领口，刀还在鞘里，像迟到的第二句话。", "套筒后锁。暴君的国土只剩空壳，连一发能认账的弹都没有。"] },
    { id: "job_sniper", n: "未归·处刑狙击", r: "SR", kind: "job", tag: "转职", school: "gun", face: "aya", dmg: 0.005, d: "最后一发打空。拥有即枪斗倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是被派去处刑镜核的那一枪。距离够远，心跳却比子弹更早到达准星。", "我趴过神社屋顶，也趴过企业天台。手枪守近，太刀守退路，狙击只守这一发。", "最后一发打空。近身已经没有时间，处刑改成被处刑，花瓣盖住准星。", "准星还在。人已经不在那条直线上，只留下一枚没认账的空壳。"] },
    { id: "job_plagueDoctor", n: "未归·瘟疫医师", r: "SR", kind: "job", tag: "转职", school: "alch", face: "aya", dmg: 0.005, d: "处方反噬署名。拥有即炼金倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把瘟疫写成处方的炼金绫。面具比脸先成为我，药味比姓名先被人记住。", "手枪看守火候，太刀切开试剂。我把别人的名字熬成能喝的东西，还假装这是治疗。", "处方反噬署名。封条在坩埚里烧成失败的味道，玻璃也沿着我的倒影裂开。", "药还在响。医师已经不值得过滤，只值得被写进下一张作废的单。"] },
    { id: "job_philosopher", n: "未归·贤者之石", r: "SR", kind: "job", tag: "转职", school: "alch", face: "aya", dmg: 0.005, d: "石头答应永生不答应完整。拥有即炼金倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是还想炼出石头的那一版绫。石头答应永生，却不答应把人炼得完整。", "我把封条当瓶盖，把作废券当配方。手枪守炉，太刀守冷却，像守一座不肯承认的坟。", "石头先炼化了炼金台。人变成渣，核变成更亮的废料，连工号都熔进底。", "炉是冷的。我的名字写在残渣上，比任何一句咒语都清楚。"] },
    { id: "job_bloodDuke", n: "未归·鲜血公爵", r: "SR", kind: "job", tag: "转职", school: "vamp", face: "aya", dmg: 0.005, d: "最后一口吸空的是自己。拥有即血族倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把血统写成爵位的血族绫。血不是别人的，是企业拆剩下、又被我饮回去的我。", "手枪守墓园，太刀守喉咙。花谢得比夜快，我喝得比花更快，像赶一份清单。", "最后一瓶写着自己的名字。吸空以后，连扣扳机的力气都退成水色。", "爵冠是空的。泪比血晚到，也比血更不像胜利。"] },
    { id: "job_batQueen", n: "未归·夜蝠女王", r: "SR", kind: "job", tag: "转职", school: "vamp", face: "aya", dmg: 0.005, d: "蝠群先离开王座。拥有即血族倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把夜蝠认作宫廷的那一版绫。它们认血，不认我戴歪的那顶王冠。", "我把翅膀编进风衣。手枪是权杖，太刀是还没来得及签署的条约，花瓣是未干的印。", "蝠群先离开王座。镜子比我更像女王，我被留在空的夜里，连一声召回都没有。", "翅膀还在远处响。冠已经掉进坟里，像一枚不肯退回的聘礼。"] },
    { id: "job_element", n: "未归·元素统御", r: "SR", kind: "job", tag: "转职", school: "mage", face: "aya", dmg: 0.005, d: "元素先统御施法者。拥有即魔法师倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是捏着通行证想统御元素的绫。券是金的，门是假的，火却认认真真地烫手。", "法阵画在水里，手枪还在腰上。我以为火和冰能被念咒排队，像企业里的零件。", "元素先统御了施法者。券面盖了作废，法阵从掌心往外死，墨比血先干。", "VOID 两个字母比我的咒语清楚，也比我的名字更像结局。"] },
    { id: "job_timeMage", n: "未归·时序魔导师", r: "SR", kind: "job", tag: "转职", school: "mage", face: "aya", dmg: 0.005, d: "倒回去的只有作废戳。拥有即魔法师倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是想把时序倒回去的那一版魔法师。秒针只认规则，不认我想救回的那一夜。", "我把怀表焊进法阵。手枪守这一秒，太刀守上一秒，像把退路切成两段。", "时序先折断了导师。倒回去的只有作废戳，人停在盖戳的那一帧，连眨眼都不被允许。", "表还在走。我已经不在这一格，只剩指针还认得我的工号。"] },
    { id: "job_shadow", n: "未归·无明影刃", r: "SR", kind: "job", tag: "转职", school: "ninja", face: "aya", dmg: 0.005, d: "影遁出界人没回来。拥有即忍者倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是从镜缝里进出的那条无明影。外面的我负责开枪，里面的我负责把自己删掉。", "分身比本体勤快。我把太刀留给回来的那一格，手枪留给还站着的这一格。", "影遁出了界。分身散成灰，本体没有从裂镜对面走回来，只剩一层还举着枪的皮。", "残影还在扣扳机。刃已经不在这一侧，像把退路留在了别人的夜里。"] },
    { id: "job_bombNinja", n: "未归·爆符忍军", r: "SR", kind: "job", tag: "转职", school: "ninja", face: "aya", dmg: 0.005, d: "符先炸了归路。拥有即忍者倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把符纸写成炸药的那一支忍。爆炸比影遁守时，也比回家的路更守时。", "我把爆符贴上袖口、贴上弹匣、贴上要回来的石阶。太刀负责切开还没响的引线。", "符先炸了归路。烟散以后，军旗还在，人没有从对面走回来，只剩纸灰。", "纸灰还烫。署名栏被轰空了，像一张不肯承认失败的军令。"] },
    { id: "job_swordSaint", n: "未归·万剑仙", r: "SR", kind: "job", tag: "转职", school: "cult", face: "rion", dmg: 0.005, d: "万剑先折在别人坟上。拥有即修仙倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是黑羽家被送去飞升的那一页万剑。飞剑比家谱先出门，也比人更先学会折断。", "剑冢里每一把剑都认识我。我路过那些失败的小夜，没有对任何一把刀鞠躬。", "万剑先折在别人的坟上。刃还在振，飞出去的那一半回不来，像不肯认账的半个名字。", "我握住折断的那截。仙名没有写上，天也没有为此开过一次。"] },
    { id: "job_thunderLord", n: "未归·雷劫道君", r: "SR", kind: "job", tag: "转职", school: "cult", face: "rion", dmg: 0.005, d: "劫先劈开飞剑。拥有即修仙倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是去接雷劫的那一版修仙凛音。雷只认剑冢里的铁，不认我袖里那张发烫的道号。", "我把长刀举成避雷针。家谱在袖里发烫，飞剑在肩上发白，像提前写出的讣告。", "劫先劈开飞剑。道君的冠掉进坟里，人还站着，天却没有为此打开。", "雷还在响。署名只剩焦黑，连一句道号都写不回去。"] },
    { id: "job_titan", n: "未归·再生泰坦", r: "SR", kind: "job", tag: "转职", school: "gene", face: "rion", dmg: 0.005, d: "再生没跑过突变。拥有即基因倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是被改成泰坦的那一版基因凛音。再生写在合同里，突变却写进还在跳的肉里。", "实验室的灯和鸟居的灯一起亮。我用长刀压住往外长的那只手臂，像压住另一份遗嘱。", "再生追上伤口，没追上镜裂。红晶比皮肤先成为我，合同上的人已经对不上这张脸。", "刀还认得手。泰坦不太认得我，像认错了该复活的那一具。"] },
    { id: "job_berserk", n: "未归·超载狂战", r: "SR", kind: "job", tag: "转职", school: "gene", face: "rion", dmg: 0.005, d: "超载先烧掉刹车。拥有即基因倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把再生拧到超载的狂战。力量先到，名字后碎，像一份写反了的紧急合同。", "我一路砍到剑冢最深处。血比家谱诚实，刀比合同短，连停手的字都没有。", "超载先烧掉刹车。突变追上狂战，人变成还在挥的那一截，连回头的余地都没有。", "刀还在响。我已经停不下来，也没有谁能替我按停。"] },
    { id: "job_beast", n: "未归·百兽统御", r: "SR", kind: "job", tag: "转职", school: "summon", face: "rion", dmg: 0.005, d: "百兽先统御署名。拥有即召唤倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是把影子当成百兽的召唤凛音。契约纸比刀快，反噬比任何部下都守时。", "我在腕上缠满符。刀尖指着该来的兽，它却从背后先到，像早就读过我的署名。", "百兽先统御了署名。红线勒进刀柄，影子比我更高，主人反而要低头。", "符烧完了。兽还在，主人不在，只剩空的腕和还在跳的线。"] },
    { id: "job_heroic", n: "未归·英灵契约", r: "SR", kind: "job", tag: "转职", school: "summon", face: "rion", dmg: 0.005, d: "英灵先收下契约。拥有即召唤倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是去签英灵的那一版召唤。英灵认剑冢里的死，不认还站着的这一具凛音。", "我把名字写进契。刀是祭品，血是印章，影子是还没赶到的部下。", "英灵先收下契约。人被写成祭品，影子比我更先成为英雄，连鞠躬都轮不到我。", "契还在腕上发烫。署名已经被收走，像一笔不肯退回的聘金。"] },
    { id: "job_boneKing", n: "未归·白骨君王", r: "SR", kind: "job", tag: "转职", school: "necro", face: "rion", dmg: 0.005, d: "先称王的是自己的骨头。拥有即死灵倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是看见终章以后还想称王的死灵。先称王的不是我，是自己已经亮起来的骨头。", "魂火从掌心往上爬。刀还在，名字开始透明，像被谁从家谱上轻轻擦掉。", "我把凛音收成可召唤的白骨。契约成立的瞬间，王冠戴在空的颅骨上，很合适。", "火还亮。君王的署名栏空了，只剩一具还想发令的架子。"] },
    { id: "job_soulHerd", n: "未归·群魂牧者", r: "SR", kind: "job", tag: "转职", school: "necro", face: "rion", dmg: 0.005, d: "群魂先牧走牧者。拥有即死灵倾向 ×1.5，全伤害 +0.5%。同卡并星加伤，最高五星。", lore: ["我是去牧群魂的那一版死灵凛音。魂认终章里的火，不认我手里这根还在发抖的牧鞭。", "我把刀当杖，把失败的小夜当成羊。火一路亮到剑冢门口，像一条不肯回头的路。", "群魂先牧走了牧者。人变成燃料，鞭还在空中响，羊群比我更认得方向。", "火还在远处走。我已经不在羊群里，只剩一句没来得及喊停的名字。"] },
  ]);
  var FUSION_CARDS = Object.freeze([
    { id: "fusion_magitech", n: "未归·星核机甲少女", r: "SSR", kind: "fusion", tag: "融合", pair: ["mech", "magical"], face: "sayo", dmg: 0.008, d: "机甲裂开仍是小夜。拥有即机械师与魔法少女倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把星核焊进机甲胸口的那一版小夜。无人机当姐姐，冠却还想把我写成魔法少女。", "我一路用步枪当遥控器。星冠戴上以后，机甲仍裂着，露出里面还是神社那件白外套。", "机甲先裂开。无人机去追星核的热，冠还亮，人已经从缝里掉出来。", "遥控器烫手。我还是小夜，只是再也拼不回完整的一夜。"] },
    { id: "fusion_gunshrine", n: "未归·祓魔枪巫女", r: "SSR", kind: "fusion", tag: "融合", pair: ["gun", "shrine"], face: "sayo", dmg: 0.008, d: "步枪写符，符烧完。拥有即枪斗与巫女倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把符纸写进弹匣的那一夜巫女。步枪是鸟居，符是还没干的朱砂。", "我把封条一层层贴上枪管，贴上准星，贴上自己的袖口。外面的备份还在扫地。", "符烧完了。祓魔波停在半空，镜核比名字先亮，朱砂把失败写得很工整。", "我仍举着空枪。封条比弹壳先落地。"] },
    { id: "fusion_bloodstar", n: "未归·血月魔法少女", r: "SSR", kind: "fusion", tag: "融合", pair: ["vamp", "magical"], face: "sayo", dmg: 0.008, d: "冠还亮，血从变身缝里漏。拥有即血族与魔法少女倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是想在血月下变身的那一版小夜。冠比我先发光，血却比咒语先出门。", "变身只走到一只手套。其余的我还是神社外套，步枪没有变成权杖，花瓣沾着自己的血。", "冠还亮着，变身缝却裂开。血从缝里漏出来，像另一层不肯干的妆。", "金边还烫。咒语停在一半，人已经空了。"] },
    { id: "fusion_bloodmech", n: "未归·血械猎姬", r: "SSR", kind: "fusion", tag: "融合", pair: ["vamp", "mech"], face: "sayo", dmg: 0.008, d: "无人机喝血，遥控器烫手。拥有即血族与机械师倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把无人机养成猎犬的血械小夜。它们认血，不认我按下去的召回。", "我把樱花焊在机翼上。步枪当鞭，遥控器当项圈，一路把它们喂到镜核门口。", "无人机先喝空了补给，再回头喝署名。遥控器烫得握不住，像握着别人的喉咙。", "螺旋桨还在远处响。猎姬已经没有可召回的夜。"] },
    { id: "fusion_idolgun", n: "未归·枪火偶像", r: "SSR", kind: "fusion", tag: "融合", pair: ["idol", "gun"], face: "sayo", dmg: 0.008, d: "麦和步枪抢同一只手。拥有即歌姬与枪斗倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是被推进舞台还要开枪的那一版小夜。麦克风和步枪抢同一只手，节拍比准星更凶。", "歌比子弹先出门。我把步枪举成麦，对着空的灯把词唱完，又把弹匣唱空。", "麦和枪一起掉下去。高连击的安可没有来，只有空仓的回声在鞠躬。", "下一首歌自动连播。我已经不在频率上。"] },
    { id: "fusion_thunderpriest", n: "未归·雷火天师", r: "SSR", kind: "fusion", tag: "融合", pair: ["mage", "shrine"], face: "sayo", dmg: 0.008, d: "符接雷，人被天罚先劈。拥有即魔法师与巫女倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是去接天罚的那一版巫女。符纸写着雷，天却只认我袖里发烫的名字。", "我把符接在步枪上，像把鸟居举成避雷针。朱砂比咒语先亮，也比人更先焦。", "雷先劈开了施法的人。符烧成灰，天罚落在肩上，镜核反而更亮。", "雷还在响。我已经不值得被写成天师，只值得被写成焦黑的一张纸。"] },
    { id: "fusion_plagueidol", n: "未归·瘟律歌姬", r: "SSR", kind: "fusion", tag: "融合", pair: ["alch", "idol"], face: "sayo", dmg: 0.008, d: "节拍带腐蚀，观众席在溶。拥有即炼金与歌姬倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是对着腐蚀开口的那一版歌姬。节拍能带动观众，也能把观众席炼化。", "我一路把酸液写进歌词。麦克风比坩埚先烫手，花比药先落地，像抢着宣布无效。", "观众席先溶掉。尸潮还在打拍子，人已经跪在还冒泡的花瓣里。", "掌声是空的。歌还在连播，连一句完整的安可都没有。"] },
    { id: "fusion_railsword", n: "未归·磁轨剑阵", r: "SSR", kind: "fusion", tag: "融合", pair: ["mech", "cult"], face: "sayo", dmg: 0.008, d: "飞剑当铆钉，轨道自己弯。拥有即机械师与修仙倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是想用磁轨钉住飞剑的那一版小夜。轨道比刃更直，也比人更容易弯向镜核。", "我把飞剑当成铆钉一节节焊上天穹。步枪当绝缘体，人当还没熔的垫片。", "轨道自己弯了。飞剑先吸走弹壳，再吸走准星，把我留在地上。", "铁还在震。我的手已经对不上极性，像对不上自己的姓。"] },
    { id: "fusion_flowerplague", n: "未归·花疫魔女", r: "SSR", kind: "fusion", tag: "融合", pair: ["magical", "spore"], face: "sayo", dmg: 0.008, d: "花弹开在别人身上。拥有即魔法少女与菌群倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把花弹认作奇迹的魔法少女。花开在别人身上，种子却不肯回到我手里。", "我一路把孢子编进没转完的变身。冠还亮，步枪当花茎，菌丝当另一层裙摆。", "花弹先开在路过的人身上。花园吞掉脚印，再吞掉园丁，镜核从花心里长出来。", "花还香。我已经是土，连浇水的手都埋进去了。"] },
    { id: "fusion_fleshshrine", n: "未归·生体御神子", r: "SSR", kind: "fusion", tag: "融合", pair: ["gene", "shrine"], face: "sayo", dmg: 0.008, d: "符刻进肉，结界是血。拥有即基因与巫女倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把符刻进肉里的那一版巫女。结界答应护身，却只答应用血来画边。", "我把朱砂写进再生的缝。步枪靠在鸟居上，皮肤自己长成符纸，像一件不肯脱的祭服。", "结界先变成血。符还在肉里亮，人已经被自己的护身勒住，连呼吸都要盖章。", "鸟居还在。我的影子短了一截，像被谁先收走了半只。"] },
    { id: "fusion_shadowmage", n: "未归·影法魔女", r: "SSR", kind: "fusion", tag: "融合", pair: ["ninja", "mage"], face: "aya", dmg: 0.008, d: "残影带火冰，本体没回来。拥有即忍者与魔法师倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是从镜缝里施法的那条影。外面的我负责开枪，里面的我负责把火和冰留下来。", "分身比本体勤快。苦无随机沾上元素，太刀留给回来的那一格，手枪留给还站着的这一格。", "残影还在喷火喷冰。本体没有从裂镜对面走回来，只剩一层还举着枪的皮。", "法阵还在这一侧亮。人已经不在这一侧。"] },
    { id: "fusion_bloodmage", n: "未归·血焰术士", r: "SSR", kind: "fusion", tag: "融合", pair: ["vamp", "mage"], face: "aya", dmg: 0.008, d: "法阵喝自己的血。拥有即血族与魔法师倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把法阵养成嘴的血焰绫。券是金的，门是假的，阵却认认真真地喝。", "我把血契画进水里。手枪还在腰上，太刀守冷却，像守一座不肯承认的炉。", "法阵先喝空了施法的人。券面盖了作废，墨从掌心滴进去，比血先干。", "VOID 两个字母比咒语清楚，也比我的工号更像结局。"] },
    { id: "fusion_nanoninja", n: "未归·纳米机忍", r: "SSR", kind: "fusion", tag: "融合", pair: ["mech", "ninja"], face: "aya", dmg: 0.008, d: "无人机抄影遁，人留在镜缝。拥有即机械师与忍者倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是让无人机去抄影遁的那一支忍。光学诱饵比人守时，归路却不守时。", "我把苦无焊进螺旋桨。冲刺留下斩击，机翼留下残影，像把回家的路复印了无数张。", "无人机先走进镜缝。人留在这一侧，诱饵散成灰，召回键只回一行冷字。", "屏幕黑了。影还在飞，署名已经不在这一格。"] },
    { id: "fusion_shadowblade", n: "未归·御剑影忍", r: "SSR", kind: "fusion", tag: "融合", pair: ["ninja", "cult"], face: "aya", dmg: 0.008, d: "飞剑斩过，影没归鞘。拥有即忍者与修仙倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把飞剑写成影的那一支忍。刃比人先出门，鞘却等不到回来的那一格。", "我把影遁焊进剑阵。太刀负责切开标记，手枪留给还站着的这一侧。", "飞剑斩过镜核。影没有归鞘，人停在出鞘的那一帧，连眨眼都不被允许。", "刃还在振。鞘是空的，像一句不肯认账的退路。"] },
    { id: "fusion_plagueforge", n: "未归·瘟炼菌海", r: "SSR", kind: "fusion", tag: "融合", pair: ["alch", "spore"], face: "aya", dmg: 0.008, d: "坩埚里的菌不认署名。拥有即炼金与菌群倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把菌海熬进坩埚的炼金绫。它们发光，却不认我写在瓶盖上的工号。", "手枪看守火候，太刀切开试剂。我把神社封条当瓶盖，把孢子当一场不肯停的雨。", "坩埚里的菌先选择了镜核。盖子着了，人变成过期的培养基，从胸口往外被吃空。", "药还在响。署名已经发酵完了，只剩甜得发苦的气味。"] },
    { id: "fusion_biogun", n: "未归·活体弹仓", r: "SSR", kind: "fusion", tag: "融合", pair: ["gene", "gun"], face: "aya", dmg: 0.008, d: "弹匣长肉，枪口朝前。拥有即基因与枪斗倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把弹匣养成活物的枪线。它们会呼吸，也会在上膛的时候咬手。", "我把再生写进弹壳。手枪朝前，太刀守退路，花瓣总是提醒我再快一点。", "弹匣先长出了自己的牙。枪口还朝前，人已经被后坐力按在墙上，近身的爪子摸到领口。", "套筒后锁。活弹还在跳，处刑改成被处刑。"] },
    { id: "fusion_bloodsword", n: "未归·血炼剑仙", r: "SSR", kind: "fusion", tag: "融合", pair: ["vamp", "cult"], face: "rion", dmg: 0.008, d: "飞剑以血为炉，冠空。拥有即血族与修仙倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把血当成炉火的那一页飞升。飞剑比家谱先出门，冠却先空了。", "剑冢里每一把剑都认识我。我路过那些失败的小夜，没有对任何一把刀鞠躬。", "飞剑以我的血为炉。刃还在振，飞出去的那一半回不来，冠掉进坟里。", "我握住折断的那截。仙名没有写上，天也没有为此开过一次。"] },
    { id: "fusion_chimera", n: "未归·元素嵌合体", r: "SSR", kind: "fusion", tag: "融合", pair: ["gene", "mage"], face: "rion", dmg: 0.008, d: "看见自己手臂的法阵。拥有即基因与魔法师倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是被嵌进元素的那一版凛音。火、冰、雷写在肉里，合同上的人已经对不上这张脸。", "我用长刀压住往外长的那只手臂。法阵从皮肤下亮起来，像另一份不肯签字的遗嘱。", "我看见自己手臂上的法阵先活了。元素统御了施法者，人变成还在发光的嵌件。", "刀还认得手。嵌合体不太认得我。"] },
    { id: "fusion_corpseimmortal", n: "未归·尸解剑仙", r: "SSR", kind: "fusion", tag: "融合", pair: ["gene", "cult"], face: "rion", dmg: 0.008, d: "肉身先走，剑还在振。拥有即基因与修仙倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是去尸解的那一版修仙。合同写着飞升，肉身却先一步离开。", "我把再生焊进飞剑。长刀还在振，家谱在袖里发烫，像提前写出的讣告。", "肉身先走了。剑还插在剑冢里振，冠掉进水里，人已经不在这具该飞升的壳里。", "刃还在响。署名只剩焦黑，连一句道号都写不回去。"] },
    { id: "fusion_shikigami", n: "未归·百鬼阴阳师", r: "SSR", kind: "fusion", tag: "融合", pair: ["summon", "shrine"], face: "rion", dmg: 0.008, d: "百鬼比主人先鞠躬。拥有即召唤与巫女倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是去召百鬼的那一版阴阳。它们认鸟居上的符，不认还站着的这一具凛音。", "我把灵兽写进符纸。长刀是祭品，血是印章，影子是还没赶到的部下。", "百鬼先鞠躬。鞠躬的对象不是我，是镜核。主人反而要低头。", "符烧完了。鬼还在，主人不在，只剩空的腕和还在跳的线。"] },
    { id: "fusion_necrospore", n: "未归·菌尸冥主", r: "SSR", kind: "fusion", tag: "融合", pair: ["necro", "spore"], face: "rion", dmg: 0.008, d: "魂菇从自己肩上长。拥有即死灵与菌群倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是看见终章以后还想种魂菇的凛音。菇认镜子里的热，不认我手里这根发抖的刀。", "我把拘魂灯插进菌海。刀当杖，失败的小夜当成培养基，火一路亮到剑冢门口。", "魂菇先从我自己肩上长出来。人变成燃料，羊群比我更认得方向。", "火还在远处走。我已经不在羊群里，只剩一句没来得及喊停的名字。"] },
    { id: "fusion_bloodbeast", n: "未归·血契兽王", r: "SSR", kind: "fusion", tag: "融合", pair: ["summon", "vamp"], face: "rion", dmg: 0.008, d: "兽群喝的是署名。拥有即召唤与血族倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把影子当成兽群的血契。它们认血，不认我腕上那圈发烫的红线。", "我把名字写进契。刀是祭品，血是印章，部下是还没赶到的坟。", "兽群先喝空了署名。红线勒进刀柄，影子比我更高，主人反而要低头。", "契还在腕上发烫。署名已经被饮尽，像一笔不肯退回的聘金。"] },
    { id: "fusion_elementalbeast", n: "未归·元素御兽使", r: "SSR", kind: "fusion", tag: "融合", pair: ["summon", "mage"], face: "rion", dmg: 0.008, d: "使魔喷元素，鞭先断。拥有即召唤与魔法师倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是让使魔轮流喷火霜雷的那一版召唤。兽潮比咒语守时，鞭却先断。", "我把元素写进契约。长刀当鞭，灵兽当还没排队的灾，像把退路切成三段。", "使魔先喷向了持鞭的人。火、冰、雷认阵，不认我，鞭在空中先裂开。", "兽潮还在远处走。我已经没有下一记能抽下去的夜。"] },
    { id: "fusion_soulgun", n: "未归·亡骨枪骑", r: "SSR", kind: "fusion", tag: "融合", pair: ["necro", "gun"], face: "rion", dmg: 0.008, d: "弹匣收魂，刀当马鞭。拥有即死灵与枪斗倾向 ×1.6，全伤害 +0.8%。同卡并星加伤，最高五星。", lore: ["我是把魂火装进弹匣的枪骑。刀当马鞭，枪当还没写完的家谱。", "我一路把失败的小夜收成弹药。长刀抽在空鞍上，魂灯在弹壳里亮，像一队不肯下葬的马。", "弹匣先收下了牧者。贯穿的亡魂弹打出去，人停在马上，已经没有可勒的缰。", "刀还在响。马是空的，魂已经不认这个骑手。"] },
  ]);
  ...
  var LOBBY_CSS =
    ...
    ".wishDrawer46>.dhead{position:absolute;z-index:30;inset:0 0 auto 0;top:0;right:0;bottom:auto;left:0;max-width:none;width:100%;box-sizing:border-box;margin:0;padding:max(8px,env(safe-area-inset-top)) 10px 8px;background:transparent;pointer-events:none}" +
    ".wishDrawer46>.dhead h2{position:absolute;width:1px;height:1px;overflow:hidden;clip:rect(0,0,0,0)}" +
    ".wishDrawer46>.dhead .close{pointer-events:auto;width:36px;height:36px;margin-left:auto;border-radius:50%;background:#05020d88;border:1px solid #ffffff22;color:#fff7fb}" +
    ...
    ".wishHero46{position:absolute;z-index:2;left:0;top:0;bottom:0;width:48%;height:100%;object-fit:cover;object-position:center 86%;background:transparent!important;pointer-events:none;-webkit-mask-image:linear-gradient(to right,#000 0%,#000 78%,transparent 100%);mask-image:linear-gradient(to right,#000 0%,#000 78%,transparent 100%)}" +
    ...
    ".wishTitle46{position:absolute;z-index:4;top:max(44px, calc(env(safe-area-inset-top, 0px) + 36px));right:max(16px,env(safe-area-inset-right));left:auto;text-align:right;max-width:42%;pointer-events:none}" +
    ".wishSeal47{display:inline-block;margin:0 8px 0 0;padding:2px 4px 1px;border:1px solid #c44536;color:#c44536;font:600 10px/1 \"Songti SC\",\"STSong\",\"Noto Serif CJK SC\",\"Noto Serif\",serif;letter-spacing:.2em;font-style:normal;vertical-align:middle}" +
    ".wishTitle46 h3{margin:0;display:inline;font-family:\"Songti SC\",\"STSong\",\"Noto Serif CJK SC\",\"Source Han Serif SC\",\"Noto Serif\",\"Times New Roman\",serif;font-size:clamp(20px,3.2vw,26px);font-weight:600;letter-spacing:.12em;color:#f4ead8;text-shadow:0 2px 14px #05020dcc}" +
    ".wishTitle46 p{margin:6px 0 0;color:#c9c2d4;font-size:10px;letter-spacing:.16em;opacity:.8;text-shadow:0 2px 10px #05020d}" +
    ".wishPity46{position:absolute;z-index:4;left:auto;right:max(16px,env(safe-area-inset-right));bottom:112px;width:min(40%,340px);padding:0;border-radius:0;background:none;border:0}" +
    ...
    ".pityRow46 span{min-width:0;color:#c9c2d4;font-size:10px;letter-spacing:.12em;text-shadow:0 1px 8px #05020d;white-space:nowrap}" +
    ".pityRail46{flex:0 1 132px;height:2px;border-radius:99px;background:#f4ead81a;overflow:hidden;box-shadow:none}" +
    ".pityRail46 i{display:block;height:100%;border-radius:99px;background:#d4b56a;box-shadow:none}" +
    ".pityRow46.sr .pityRail46 i{background:#c9c2d4}" +
    ".wishMeta46{margin:8px 0 0;color:#c9c2d4;font:600 10px/1 system-ui;letter-spacing:.14em;text-align:right;text-shadow:0 1px 8px #05020d;opacity:.72}" +
    ".wishDock46{position:absolute;z-index:5;left:auto;right:0;bottom:0;width:min(44%,400px);padding:8px 18px calc(10px + env(safe-area-inset-bottom));background:linear-gradient(180deg,#06041000 0%,#06041077 40%,#060410ee 100%)}" +
    ".wishTabs46{position:absolute;z-index:6;top:max(12px,calc(env(safe-area-inset-top) + 4px));left:auto;right:max(56px,calc(env(safe-area-inset-right) + 48px));display:flex;gap:2px}" +
    ".wishTabs46 button{min-height:32px;padding:0 10px;border-radius:0;border:0;border-bottom:1px solid transparent;background:transparent;color:#c9c2d4aa;font:600 12px/1 system-ui;letter-spacing:.2em}" +
    ".wishTabs46 button.on{background:none;color:#f4ead8;border-bottom-color:#c44536}" +
    ".wishPills46{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:10px;margin:0 0 10px}" +
    ".wishPills46 b{padding:0;border-radius:0;background:none;border:0;color:#c9c2d4;font-size:10px;letter-spacing:.08em;font-weight:600;text-shadow:0 1px 8px #05020d}" +
    ...
    ".gachaActions46{display:flex;justify-content:flex-end;gap:8px}" +
    ".gachaActions46 button{min-height:40px;min-width:118px;padding:6px 14px;border-radius:2px;border:1px solid #f4ead844;color:#f4ead8;font:600 13px/1.1 system-ui;letter-spacing:.12em;box-shadow:none}" +
    ".gachaActions46 button small{display:block;margin-top:2px;font:600 10px/1 system-ui;letter-spacing:.06em;opacity:.72}" +
    ".gachaActions46 button.poor{opacity:.42}" +
    ".wishSpark46{display:flex;flex-wrap:nowrap;justify-content:flex-end;gap:8px;margin-top:8px;max-height:22px;overflow:auto}" +
    ".wishSpark46 button{min-height:22px;padding:0 4px;border-radius:0;border:0;background:none;color:#c9c2d4;font:600 10px/1 system-ui;opacity:.7}" +
    ...
    "#gachaPull1{background:#f4ead814;border-color:#f4ead855;color:#f4ead8}" +
    "#gachaPull10{background:#d4b56a;border-color:#d4b56a;color:#2a1608}" +
    "#gachaReveal46{position:absolute;inset:0;top:0;right:0;bottom:0;left:0;z-index:20;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:max(44px,env(safe-area-inset-top)) 12px calc(16px + env(safe-area-inset-bottom));background:radial-gradient(circle at 50% 40%,#4a2878ee,#12081cf6 68%)}" +
    ...
    ".revealFace46{position:absolute;inset:0;top:0;right:0;bottom:0;left:0;backface-visibility:hidden;-webkit-backface-visibility:hidden;border-radius:12px;overflow:hidden;border:1px solid #ffffff22}" +
    ...
    ".rosterVeil46{position:absolute;inset:0;top:0;right:0;bottom:0;left:0;display:grid;place-items:center;background:#08071388;color:#ffe6f3;font:800 12px/1 system-ui;font-style:normal;letter-spacing:.2em}" +
    ...
    ".rosterStars46{display:block;margin:2px 0 0;color:#ffe08a;letter-spacing:.1em;font-size:10px;text-shadow:0 0 8px #ffd36b66}" +
    ".rosterSlot46.lock .rosterStars46{opacity:.28}" +
    "#rosterPeek46{position:absolute;inset:0;top:0;right:0;bottom:0;left:0;z-index:24;display:flex;align-items:center;justify-content:center;padding:18px;background:#060410ee}" +
    ...
    ".wishHero46{left:0;top:0;width:48%;height:100%;bottom:0;object-fit:cover;object-position:center 86%}" +
    ...
    "html.landscape46 .wishHero46{left:0;top:0;width:48%;height:100%;bottom:0;object-fit:cover;object-position:center 86%}" +
    "html.landscape46 .wishTitle46{right:max(18px,3%);top:max(44px, calc(env(safe-area-inset-top, 0px) + 36px));max-width:38%}" +
    "html.landscape46 .wishDock46{left:auto;right:0;width:min(42%,400px)}" +
    "html.landscape46 .wishPity46{left:auto;right:max(18px,3%);top:auto;bottom:max(112px, calc(env(safe-area-inset-bottom, 0px) + 100px));width:min(38vw,340px)}" +
  ...
  var ROOM_CSS =
    ...
    "html.landscape46 #menu.homeDock46 .menu{left:auto;right:0;top:0;bottom:0;width:min(34vw,360px);max-width:360px;margin-left:auto;padding:10px 12px calc(10px + env(safe-area-inset-bottom));box-sizing:border-box}" +
  ...
  function starFromCount(n) {
    var c = clampInt(n, 0, 9999);
    if (c < 1) return 0;
    return c > STAR_MAX ? STAR_MAX : c;
  }

  function starMarks(n) {
    var star = starFromCount(n);
    var out = "";
    var i;
    for (i = 0; i < STAR_MAX; i++) out += i < star ? "★" : "☆";
    return out;
  }

  function starScale(n) {
    return starFromCount(n);
  }
  ...
  function starBonusLine(card, count) {
    var star = starFromCount(count);
    if (!card || star < 1) return "";
    if (card.dmg) {
      return "当前 " + star + " 星：全伤害 +" + pct(card.dmg * star) + "%（一星 +" + pct(card.dmg) + "%，同卡并星加伤）。";
    }
    var bonus = SCRAP_BONUS[card.id];
    if (!bonus) return "当前 " + star + " 星。同卡并星，最高五星。";
    if (bonus.crit) return "当前 " + star + " 星：暴击 +" + pct(bonus.crit * star) + "%。";
    if (bonus.spd) return "当前 " + star + " 星：移速 +" + pct(bonus.spd * star) + "%。";
    if (bonus.blade) return "当前 " + star + " 星：刀伤 +" + pct(bonus.blade * star) + "%。";
    if (bonus.skillCd) return "当前 " + star + " 星：技能冷却 -" + pct(bonus.skillCd * star) + "%。";
    if (bonus.reduce) return "当前 " + star + " 星：减伤 +" + pct(bonus.reduce * star) + "%。";
    if (bonus.shield) return "当前 " + star + " 星：开局护盾 +" + (bonus.shield * star) + "。";
    if (bonus.dmg) return "当前 " + star + " 星：全伤害 +" + pct(bonus.dmg * star) + "%。";
    if (bonus.hp) return "当前 " + star + " 星：生命 +" + pct(bonus.hp * star) + "%。";
    return "当前 " + star + " 星。同卡并星，最高五星。";
  }
  ...
  function applyOwnedBonus(player, save) {
    ...
    CARDS.forEach(function (card) {
      var count = owned[card.id] || 0;
      var star = starScale(count);
      if (star < 1) return;
      var bonus = SCRAP_BONUS[card.id];
      if (!bonus) return;
      if (bonus.crit) player.crit = (player.crit || 0) + bonus.crit * star;
      if (bonus.spd) player.spd = (player.spd || 0) * (1 + bonus.spd * star);
      if (bonus.blade) {
        player.bladePower = (player.bladePower || 1) * (1 + bonus.blade * star);
        if (cid === "rion") player.dmg = (player.dmg || 0) * (1 + bonus.blade * star);
      }
      if (bonus.skillCd) player.skillCd = (player.skillCd || 0) * (1 - bonus.skillCd * star);
      if (bonus.reduce) player.damageReduce = (player.damageReduce || 0) + bonus.reduce * star;
      if (bonus.shield) {
        player.maxSh = (player.maxSh || 0) + bonus.shield * star;
        player.sh = (player.sh || 0) + bonus.shield * star;
      }
      if (bonus.dmg) player.dmg = (player.dmg || 0) * (1 + bonus.dmg * star);
      if (bonus.hp) {
        player.maxHp = (player.maxHp || 0) * (1 + bonus.hp * star);
    ...
    if (fcard && (fashion.owned[fcard.id] || 0) > 0) {
      var fstar = starScale(fashion.owned[fcard.id] || 0);
      var fmul = (fcard.legend || fcard.r === "SSR" ? 0.08 : fcard.r === "SR" ? 0.04 : fcard.r === "R" ? 0.02 : 0.01) * fstar;
    ...
    if (wcard && (weapon.owned[wcard.id] || 0) > 0) {
      var wstar = starScale(weapon.owned[wcard.id] || 0);
      var wmul = (wcard.legend || wcard.r === "SSR" ? 0.14 : wcard.r === "SR" ? 0.08 : wcard.r === "R" ? 0.04 : 0.02) * wstar;
  ...
  function resolveBuildCard(run) {
    run = run && typeof run === "object" ? run : {};
    var fusion = run.fusion;
    if (fusion) {
      var fid = String(fusion);
      if (fid.indexOf("fusion_") !== 0) fid = "fusion_" + fid;
      if (CARD_MAP[fid]) return CARD_MAP[fid];
    }
    var careers = run.careers && typeof run.careers === "object" ? run.careers : {};
    var bestJob = null;
    var schools = [];
    Object.keys(careers).forEach(function (school) {
      var c = careers[school] || {};
      if (c.branch) {
        var bid = String(c.branch);
        var jid = bid.indexOf("job_") === 0 ? bid : "job_" + bid;
        var job = CARD_MAP[jid];
        if (job && (!bestJob || (c.rank || 0) > bestJob.rank)) bestJob = { card: job, rank: c.rank || 0 };
      } else if (c.formed && CARD_MAP["school_" + school]) {
        schools.push(CARD_MAP["school_" + school]);
      }
    });
    if (bestJob) return bestJob.card;
    var face = run.character === "aya" || run.character === "rion" ? run.character : "sayo";
    var i;
    for (i = 0; i < schools.length; i++) {
      if (schools[i].face === face) return schools[i];
    }
    if (schools[0]) return schools[0];
    var scrap = face === "aya" ? "aya_petal" : face === "rion" ? "rion_edge" : "sayo_echo";
    return CARD_MAP[scrap] || CARDS[0];
  }

  function grantBuildCard(save, run) {
    if (!save || typeof save !== "object") return { ok: false, reason: "save" };
    save.shop40 = normalizeOps(save.shop40 || {});
    var card = resolveBuildCard(run);
    if (!card) return { ok: false, reason: "card" };
    var prev = save.shop40.ops.owned[card.id] || 0;
    var next = clampInt(prev + 1, 0, 9999);
    save.shop40.ops.owned[card.id] = next;
    return {
      ok: true,
      id: card.id,
      n: card.n,
      r: card.r,
      kind: card.kind || "scrap",
      count: next,
      star: starFromCount(next),
      prevStar: starFromCount(prev),
      stars: starMarks(next),
      merged: prev > 0,
      isNew: prev < 1,
      bonus: starBonusLine(card, next),
    };
  }
  ...
  function renderGacha(host, save, handlers) {
    ...
    host.innerHTML =
      ...
      "</div>" +
      '<div class="wishTitle46"><em class="wishSeal47">鏡</em><h3>镜界寻访</h3><p>' +
      sub +
      "</p></div>" +
      ...
      ' 抽</span><div class="pityRail46"><i style="width:' +
      srPct +
      '%"></i></div></div><p class="wishMeta46">寻访 ' +
      pulls +
      " · 软保 " +
      RATES.softPity +
      "</p></div>" +
  ...
  function showRosterPeek(card, locked, count, handlers, tab) {
    ...
    var bonusLine = locked ? "" : starBonusLine(card, count);
    overlay.innerHTML =
      ...
      (card.legend ? " · 传说" : "") +
      (locked ? "" : " · " + starFromCount(count) + "星 · ×" + count) +
      "</em><p>" +
      (locked ? "尚未回收。寻访或结算构筑卡点亮后才会露出立绘。" : (bonusLine ? bonusLine + " " : "") + loreText(card)) +
      "</p>" +
    ...
    if (tab === "chronicle") {
      ...
      wall = list.map(function (card) {
        ...
        return (
          ...
          "</div><b>" +
          (locked ? "待寻访" : card.n) +
          '</b><span class="rosterStars46">' +
          starMarks(count) +
          "</span><small>" +
          (locked ? rarityLabel(card.r, card.legend) : (count < 1 ? "未回收" : starFromCount(count) + "星 · ×" + count)) +
          "</small></button>"
        );
      }).join("");
    }
  ...
  global.SakurayoLobby = {
    ...
    starFromCount: starFromCount,
    starMarks: starMarks,
    starScale: starScale,
    starBonusLine: starBonusLine,
    resolveBuildCard: resolveBuildCard,
    grantBuildCard: grantBuildCard,
    STAR_MAX: STAR_MAX,
    setPool: setPool,
