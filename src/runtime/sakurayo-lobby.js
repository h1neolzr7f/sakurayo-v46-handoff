(function (global) {
  ...
  var ROOM_CSS =
    ...
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .charSelectPanel{position:absolute!important;left:max(228px,calc(env(safe-area-inset-left) + 216px))!important;right:auto!important;top:max(10px,env(safe-area-inset-top))!important;bottom:auto!important;width:auto;margin:0;padding:0;background:transparent;border:0;box-shadow:none;z-index:7;pointer-events:auto}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .characterList{display:flex!important;flex-direction:row;gap:8px}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .charCard{width:42px;height:42px;min-width:42px;max-width:42px;margin:0;aspect-ratio:auto;padding:1px;background:#120e27cc;border:0;box-shadow:none}" +
    ...
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .stageMini{position:relative;width:100%;margin:0;flex:1 1 auto;min-height:96px;display:grid;grid-template-columns:1fr auto;grid-template-rows:auto 1fr auto;gap:4px 8px;padding:12px 14px 10px;border-radius:16px;overflow:hidden;background:#120e27ee;border:1px solid #69ddf266;box-shadow:0 0 0 1px #05020d,0 12px 28px #05020d66,inset 0 0 0 1px #69ddf222;backdrop-filter:none}" +
    ...
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .homeModes46{display:grid;grid-template-columns:1fr 1fr;gap:8px;flex:0 0 auto}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .homeModes46 button{min-height:58px;padding:8px 10px;border-radius:14px;border:1px solid #f35aa655;background:#120e27ee;color:#fff7fb;text-align:left;box-shadow:inset 0 0 0 1px #f35aa622}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .homeModes46 button i{display:block;margin-bottom:4px;color:#f35aa6;font:900 14px/1 system-ui;font-style:normal}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .homeModes46 button b{display:block;font-size:13px;letter-spacing:.06em}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .homeModes46 button small{display:block;margin-top:3px;color:#cfc4df;font:700 9px/1 system-ui;letter-spacing:.14em}" +
    ...
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .start{width:100%;margin:0;flex:0 0 auto;min-height:52px;padding:0 18px;letter-spacing:.18em;font-size:20px;border-radius:8px;clip-path:polygon(14px 0,100% 0,calc(100% - 14px) 100%,0 100%);display:flex;align-items:center;justify-content:center;gap:8px}" +
    ...
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .calmUtility39.open39>button{display:block!important}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 #moreButton39{min-height:42px;padding:0 14px;border-radius:999px;border:1px solid #f2c75d66;background:#120e27ee;color:#ffe7a3;letter-spacing:.14em;font-size:11px}" +
    "html.landscape46:not(.portraitFallback46) #menu.homeDock46 .calmUtility39.open39{position:absolute;top:48px;right:0;bottom:auto;width:min(74vw,280px)}" +
    ...
    "html.landscape46.shortWindow46 #menu.homeDock46 .charSelectPanel{top:max(6px,env(safe-area-inset-top))!important}" +
    ...
    "html.landscape46.shortWindow46 #menu.homeDock46 .homeModes46 button{min-height:42px;padding:5px 8px}" +
    "html.landscape46.shortWindow46 #menu.homeDock46 .homeModes46 button small{display:none}" +
    "html.landscape46.shortWindow46 #menu.homeDock46 .start{min-height:44px;font-size:16px;letter-spacing:.14em;clip-path:polygon(10px 0,100% 0,calc(100% - 10px) 100%,0 100%)}" +
    ...
    "html.landscape46.shortWindow46 #menu.homeDock46 .calmUtility39.open39{top:42px;width:min(74vw,240px)}" +
