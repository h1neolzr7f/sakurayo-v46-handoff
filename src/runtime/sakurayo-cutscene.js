(function (global) {
  ...
  function injectStyle() {
    ...
    style.textContent =
      ...
      "@media(max-height:430px){#level .modal{display:flex;flex-direction:column;max-height:96vh;overflow:hidden;padding:8px 12px}#level .modal h2{font-size:16px;margin:0 0 2px}#level .sub{margin:0 0 4px;font-size:10px;max-height:2.6em;overflow:hidden}#level #choices{min-height:0;flex:1 1 auto;overflow:auto}#level .choice{padding:8px 6px;min-height:0}#level .choice img{width:36px;height:36px}#level .choice p{color:#e8dcc8;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;max-height:3.4em}#level .choiceReadout38{margin-top:4px;padding:3px 6px;font-size:9px}#level .choiceReadout38 em{display:none}#reroll{min-height:40px;margin-top:6px;flex:0 0 auto;background:#2a1848;border:1px solid #f2c75d;color:#ffe7a3}#result #rstats,#result #damageReport,#result #routeNote{background:#161028;border:1px solid #f2c75d55;color:#fff4e4}#result #damageReport h3,#result #rstats b{color:#ffe7a3}.eventChoice{min-height:48px;background:#1a1230;border:1px solid #f2c75d55;color:#fff7fb}.eventChoice p{color:#e8dcc8}}" +
