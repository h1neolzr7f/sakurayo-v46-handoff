...
当前：**V4.6.6 测试版。** 公开玩家仓是 https://github.com/h1neolzr7f/sakurayo-zombietide 。
最新测试 APK：https://github.com/h1neolzr7f/sakurayo-v46-handoff/releases/download/v4.6.6/Sakurayo-ZombieTide-TEST-v4.6.6.apk
...
横屏大厅、五房、镜界寻访（只收藏）、证词模式、仿 Live2D。局内塔防坞已退役。版本号是 4.6.6。
