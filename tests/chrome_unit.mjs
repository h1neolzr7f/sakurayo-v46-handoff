...
assert.match(workflow, /versionCode 6113/);
...
assert.match(code, /talismanIco/);
assert.match(code, /tmech:function/);
assert.match(code, /tnecro:function/);
assert.match(code, /gift:"gift"/);
...
assert.match(code, /install\.done/);
assert.doesNotMatch(code, /documentElement\.__chromeWatch/);
assert.doesNotMatch(code, /button, p, small, em/);
