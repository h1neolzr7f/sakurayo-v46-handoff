...
assert.equal(await page.locator(".shopRail46 button").count(), 6);
assert.equal(await page.locator("#shopFeatured46 .shopSkin46").count(), 3);
...
assert.match(await page.locator("#shopFeatured46").textContent(), /寻访券/);
