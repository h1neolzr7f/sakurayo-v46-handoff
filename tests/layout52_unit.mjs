...
assert.match(L.css, /portraitFallback46 #menu\.homeDock46 \.homeRail46\{position:absolute!important/);
assert.match(L.css, /#menu\.homeDock46 \.homeDeck46 \.stageMini\{cursor:pointer\}/);
assert.match(L.css, /#menu\.homeDock46 #start,html\.landscape46:not\(\.portraitFallback46\) #menu\.homeDock46 \.start\{clip-path:none!important/);
