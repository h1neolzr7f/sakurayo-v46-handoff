...
档案「樱核树」是局外樱花币点枝界面，数据仍写 `save.tal`（atk/hp/luck/mag/flow），不要改成卖永久伤害的抽卡。
...
- 左约 **64%**：当前角色全身立绘栏，**头要完整**。立绘本体 `height:78%`、`width:min(42vw,440px)`、`object-fit:contain`、`object-position: center 10%`。不要再写成 138% 或 100% 撑满裁头。标题「樱夜·尸潮」贴左上，角色名贴左下。
