...
- 四章剧情、Boss 四阶段（75% / 50% / 25%）、主神空间。局内对白先对人话、对准情绪（放不下的人 / 被写成办完 / 接过位置却填不上名字），设定和仓库卡后置。终章先打出写定的最坏结局；八步线索都做对且通关前三章后，才进更强隐藏关，打完才给完美结局。不要开场论文，也不要谜语。选项 flag 与未归卡四段、小夜编年五条不要改正文。凛「先问她想不想活」和失败电台「晚安，小夜 / 绫 / 凛音」不要改。
- 触控摇杆、冲刺、主动技能必须可用。
