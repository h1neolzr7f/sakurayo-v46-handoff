...
2026-08-19。对照 `docs/CURSOR_PROMPT_PHASE2.md` 11 条。施工 PR：https://github.com/h1neolzr7f/sakurayo-v46-handoff/pull/11 @ `8193eed`。

**结论：未收工。打回 1 张 `job_garden`。** 逻辑、旧图、抽卡分布、其余 27 张认人/绫枪可过。不要合并。
...
- **`job_garden`**：表写「种花笑裂、一滴泪」。图是围裙跪泥、步枪当锄、对着尸花/镜核**纯哭**，嘴角下撇，没有笑裂。和 `hive` 同属「菌校小夜倒下/含泪」，情绪没拆开。整张重画：必须看见裂开的笑，泪只留一滴。
...
施工只重画 `job_garden`。逻辑、其余 27 张、旧图都不要动。人再看这一张过了才能点合并。
