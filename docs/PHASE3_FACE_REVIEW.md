...
head：`0b992ff`。基线 `origin/main` @ `0657136`。版本仍 **4.6.0**。

**结论：逻辑过，封面未过。不要合并。** 只重画下面两张。其余 22 张、lobby / 加成 / 测试、旧 8/14/28/传说/公共图不要动。
...
图是：枪口对着镜头；裂镜里还有一张完整的脸。第二期刚为绫枪姿重画过一轮，这张不能过。

### `fusion_necrospore` 菌尸冥主（凛音）

要：黑红+长刀当杖；魂菇从自己肩上长出来；嫌恶带倦。失败句是「菇从自己身上长」，不是「手里捧着菇」。

图是：站着捧一簇发光蘑菇，菇没长在肩上/身上。和 `job_garden` 同一类：自检写了失败，图是持物立绘。
