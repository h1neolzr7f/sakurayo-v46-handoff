...
- 出图预览页：`docs/NAI_GALLERY.md`，GitHub 打开即可看入库图。
- 继续用免费 v4.5 把还能出的图出完：16 种怪+第二帧、16 章 Boss、虚空 Boss/小怪、4 宠物、14 基础/28 转职/24 融合改成无人静物卡、探索地图、飞升/转职/融合闪屏、封面、导航和流派图标。重抽樱冠和三张偏了的武器。再补 28 张转职 `full.webp`（升级页去掉第四张脸）、48 张技能图标、职业/融合/飞升图标、16 张绿幕特效和锁定/应用/成就徽记。Anlas 仍为 0。不出三角色站桩和时装卡。
