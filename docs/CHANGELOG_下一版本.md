...
- 大厅右栏改成上选角、下出击+五格；五格圆钮压过 `#menu .nav` 的 34px 方底；立绘名牌加金边底板。
- 商店横屏衣装改 2×2 左图右文，预览见方能看见脸，四张购买钮都在 932×430 视口内。
- 寻访保底条贴在抽卡坞上方；碎镜兑换仍是字链；翻牌花瓣不挡关闭钮。
- 关卡字幕条与卡角「未通关」、仓库卡面加高、档案四格铺满。新增 `tests/layout_audit46.mjs` 量布局。
- 未升 4.6.1。未入库 BGM / 战场 / idle。
