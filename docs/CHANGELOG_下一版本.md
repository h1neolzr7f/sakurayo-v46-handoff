...
- 对照《无限恐怖》第一部主线（生化一到神鬼传奇/终战）整理道具与血统，只借鉴高层概念，不照搬原名。
- 主神货架新增 6 项跨轮回兑换：本能解锁序列、镜核原液变异、零时差感应环、轮回队长印、监管防弹织层、裁决投针。
- 仍只在主神空间生效；旧存档缺字段补 0；大厅重置可全额返还。对照表见 `docs/主神兑换_第一部对照.md`。
