...
- 继续用免费 v4.5 把还能出的图出完：16 种怪+第二帧、16 章 Boss、虚空 Boss/小怪、4 宠物、14 基础/28 转职/24 融合改成无人静物卡、探索地图、飞升/转职/融合闪屏、封面、导航和流派图标。重抽樱冠和三张偏了的武器。队列再补转职 `full.webp`、技能/职业/融合/飞升图标和 16 张战斗特效。Anlas 仍为 0。不出三角色站桩和时装卡。
