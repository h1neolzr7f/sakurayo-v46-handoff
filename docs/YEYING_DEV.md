...
| versionName | `4.7.3-yeying` | `4.4.6`（公开仓） |
| 存档沙盒 | 独立 | 独立 |
| 覆盖安装 | 不会顶掉正式版 | 不会顶掉开发版 |

## 安装

1. 装本机 `release/YeYing-Dev-v4.7.3-android.apk`，或 GitHub Releases 的 `yeying-dev-v4.7.3`
...
```
D593B28F5B732D88054208EBC3D72803B5860D3E929F0EA66336DD95BDACA631
```
...
覆盖安装 `versionCode 6113` 即可，不会动正式《樱夜·尸潮》。
